...
RESULTS_DIR = "results"
PRODUCT = "FubuRelease"
COPYRIGHT = 'Copyright 2012 FubuRelease. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version, :bundle_getting_started] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuRelease.sln', :clrversion => CLR_TOOLS_VERSION
...
task :bundle_getting_started do
  bottles("assembly-pak src/FubuMVC.GettingStarted --proj-file FubuMVC.GettingStarted.csproj")
end
